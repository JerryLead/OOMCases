...
public class ReducePhaseOOM extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		//OOM in reduce phase
		// /syntheticData/brownTables/samples/RankingsFiltered/{part-m-0001*}  /syntheticData/brownTables/samples/RankingsFiltered2/{part-m-0001*}  /user/xulijie/output/ReducePhaseOOM
		if (args.length != 3) {
			System.out.println("Usage: <Table A input> <Table B input> <output>");
			return -1;
		}
		JobConf conf = new JobConf(getConf(), getClass());
		conf.setJobName("ReducePhaseOOM");
		...
		conf.set(
		 ...
		 "-Xmx1500m -Xms1500m -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/tmp -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps");
		
	    //conf.set("mapred.child.java.opts", "-Xmx1500m -Xms1500m");
	...
	//conf.setFloat("mapred.job.reduce.input.buffer.percent", 0.4f);
		...
		conf.set("heapdump.reduce.input.records", "1;1425883;2851765;4277647;5703529;7129414;7129415");
		conf.set("heapdump.task.attempt.ids", "attempt_201404152256_0010_r_000000_0");
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new ReducePhaseOOM(), args);
